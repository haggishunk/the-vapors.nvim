...
-- highlight groups
Group.new("Boolean", colors.vivid_sky, nil, styles.bold)
...
Group.new("jsonKeyword", colors.vapor_purple, nil, styles.bold)
Group.new("Keyword", colors.vapor_purple, nil, styles.bold)
...
Group.new("Operator", colors.guppie_green)
...
Group.new("perlOperator", colors.guppie_green)
...
Group.new("shOperator", colors.guppie_green)
Group.new("shShellVariables" , colors.cola_blue)
Group.new("shSnglCase", colors.bolt_blue)
Group.new("shTestOpr", colors.guppie_green)
Group.new("shVariable", colors.cola_blue, nil, styles.bold)
...
Group.new("String", colors.sky_blue)
Group.new("Structure", colors.hulk_pants, nil, styles.bold)
